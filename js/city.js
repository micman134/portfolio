...
city_states['Haiti'] = '|Port-au-Prince||Artibonite|Centre|GrandAnse|Nord|Nord-Est|Nord-Ouest|Ouest|Sud|Sud-Est';
...
city_states['Bahrain'] = '|Manama||Al Hadd|Al Manamah|Al Mintaqah al Gharbiyah|Al Mintaqah al Wusta|Al Mintaqah ash Shamaliyah|Al Muharraq|Ar Rifawa al Mintaqah al Janubiyah|Jidd Hafs|Madinat Hamad|Madinat Isa|Juzur Hawar|Sitrah';
...
function getCountry()
{
    ...
    if (countries.hasOwnProperty(continent)) {
        var countryArray = countries[continent].split('|').filter(Boolean);
...
function updateStateOptions() {
  ...
  var stateOptions = city_states[selectedCountry].split('|').filter(Boolean);
...
// Initial update of state options when page loads
updateStateOptions();
